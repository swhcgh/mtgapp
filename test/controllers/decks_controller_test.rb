...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { Cardlist: @deck.Cardlist, contender_id: @deck.contender_id } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { Cardlist: @deck.Cardlist, contender_id: @deck.contender_id } }
